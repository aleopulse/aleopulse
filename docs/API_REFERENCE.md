# LeoPulse API Reference

## Base URL

- **Development**: `http://localhost:5000/api`
- **Production**: `https://leopulse.xyz/api`
...
{
  "leaderboard": [
    { "rank": 1, "address": "aleo1...", "points": 1500, "tier": "platinum" },
    { "rank": 2, "address": "aleo1...", "points": 1200, "tier": "gold" }
  ]
}
```
...
{
  "code": "abc123",
  "link": "https://leopulse.xyz?ref=abc123"
}
```
...
The gas sponsorship service is under development. Once available, the following endpoints will be provided:
...
**Note**: Gas sponsorship leverages Aleo's native fee delegation mechanism. See the `aleo-gs` project for implementation details.
